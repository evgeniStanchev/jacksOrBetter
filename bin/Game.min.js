...
(function (views) {
    var BetButtonsView = /** @class */ (function (_super) {
        ...
        BetButtonsView.prototype.updateAction = function (newLabel) {
            for (var _i = 0, _a = this._buttons; _i < _a.length; _i++) {
                var button = _a[_i];
                if (!button.isMaxBet) {
...
(function (controllers) {
    ...
    var ButtonsController = /** @class */ (function (_super) {
        ...
        function ButtonsController() {
            ...
            _this._view.on("buttonClicked", _this.onButtonClicked, _this);
            return _this;
        }
        ...
        ButtonsController.prototype.onButtonClicked = function (selectedButton) {
        ...
        ButtonsController.prototype.onButtonDrawClicked = function () {
            console.log("sending notification:", Notification.BUTTON_CLICK_DRAW);
            this.sendNotification(Notification.BUTTON_CLICK_DRAW);
        };
        ButtonsController.prototype.onButtonDealClicked = function (selectedButton) {
        ...
        ButtonsController.prototype.onButtonCollectClicked = function () {
...
(function (poker) {
    ...
    var Main = /** @class */ (function (_super) {
        ...
        Main.prototype.requestDraw = function (bet) {
...
(function (poker) {
    var State;
    (function (State) {
        State[State["DEAL"] = 0] = "DEAL";
        State[State["DRAW"] = 1] = "DRAW";
        State[State["COLLECT"] = 2] = "COLLECT";
    })(State = poker.State || (poker.State = {}));
})(poker || (poker = {}));
///<reference path="../State.ts"/>
///<reference path="../Main.ts"/>
var server;
(function (server) {
    var State = poker.State;
    var Server = /** @class */ (function () {
        function Server(facade, balance) {
            ...
            this._facade.on("resources loaded", function () {
                var data = {
                    action: "setBalance",
                    amount: balance,
                };
                _this._facade.data = data;
            });
            this._state = State.DEAL;
        }
        Server.prototype.requestDraw = function (request) {
