...
(function (model) {
    ...
    var GameModel = /** @class */ (function (_super) {
        ...
        GameModel.prototype.requestDeal = function (bet) {
            if (bet <= this.balance) {
                this.balance -= bet;
                return true;
            }
...
(function (views) {
    var BetButtonsView = /** @class */ (function (_super) {
        ...
        BetButtonsView.prototype.isWin = function () {
            var isWin = Math.floor(Math.random() * 10) % 2 == 0 ? true : false;
...
(function (controllers) {
    ...
    var ButtonsController = /** @class */ (function (_super) {
        ...
        function ButtonsController() {
            ...
            _this._view.on("draw clicked", _this.onButtonDraw, _this);
            _this._view.on("deal clicked", _this.onButtonDeal, _this);
            _this._view.on("collect clicked", _this.onButtonCollect, _this);
            return _this;
        }
        ...
        ButtonsController.prototype.onButtonDeal = function (selectedButton) {
...
(function (controllers) {
    ...
    var BalanceController = /** @class */ (function (_super) {
        ...
        function BalanceController() {
            ...
            return _super.call(this, new BalanceView(5000)) || this;
        }
...
(function (views) {
    var ActionView = /** @class */ (function (_super) {
        ...
        ActionView.prototype.setTexts = function () {
        ...
        ActionView.prototype.drawFigure = function () {
            this.lineStyle(2, 0x014d8a);
            this.beginFill(0x000000);
            this.drawRoundedRect(this._x, this._y, this._width, this._height, this._radius);
            this.endFill();
...
(function (poker) {
    ...
    var Main = /** @class */ (function (_super) {
        ...
        Main.prototype.requestDraw = function () {
        ...
        Main.REQUEST_DEAL = "requestBet";
        Main.REQUEST_DRAW = "requestDraw";
        Main.REQUEST_COLLECT = "requestCollect";
        return Main;
    }(PIXI.utils.EventEmitter));
    poker.Main = Main;
})(poker || (poker = {}));
