...
(function (server) {
    ...
    var Server = /** @class */ (function () {
        function Server(facade, balance) {
            ...
            this._requestRestart = "requestRestart";
        ...
        Server.prototype.requestRestart = function () {
            // if (this._state == "Deal") {
        ...
        //TODO alternative
        Server.prototype.getRandomRank = function () {
            var num = Math.floor((Math.random() * 20) % 13) + 2;
            console.log(num);
            switch (num) {
                case 2: {
        ...
        //TODO alternative
        Server.prototype.getRandomSuit = function () {
            var num = Math.floor(Math.random() * 10) % 4;
            switch (num) {
                case 0: {
                    return "C";
