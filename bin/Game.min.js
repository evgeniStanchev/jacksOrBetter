...
(function (poker) {
    var Notifications = /** @class */ (function () {
        ...
        Notifications.BUTTON_CLICK_DRAW = "draw";
        Notifications.BUTTON_CLICK_DEAL = "deal";
        Notifications.BUTTON_CLICK_COLLECT = "collect";
...
(function (views) {
    var BalanceView = /** @class */ (function (_super) {
        ...
        function BalanceView() {
            ...
            _this.lineStyle(2, 0x014d8a);
            _this.beginFill(0x000000);
            _this.drawRoundedRect(_this._x, _this._y, _this._width, _this._height, _this._radius);
            _this.endFill();
            _this._balanceLabel.x = _this._x + (_this._width - _this._balanceLabel.width) / 2;
            _this._balanceLabel.y = _this._y - 5;
            _this.addChild(_this._balanceLabel);
            return _this;
        }
        return BalanceView;
    }(PIXI.Graphics));
...
(function (poker) {
    ...
    var Main = /** @class */ (function (_super) {
        ...
        Main.prototype.requestDeal = function () {
