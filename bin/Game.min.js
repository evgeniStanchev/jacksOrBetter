...
(function (controllers) {
    ...
    var BalanceController = /** @class */ (function (_super) {
        ...
        function BalanceController(mModel) {
            ...
            _super.call(this, new BalanceView()) || this;
...
(function (server) {
    var CardsUtils = /** @class */ (function () {
        ...
        CardsUtils.fourOfAKind = function (card) {
            ...
            //xxxxy
            var firstCase = sortedRanks[0] == sortedRanks[1] &&
                sortedRanks[1] == sortedRanks[2] &&
                sortedRanks[2] == sortedRanks[3];
            //yxxxx
            var secondCase = sortedRanks[1] == sortedRanks[2] &&
                sortedRanks[2] == sortedRanks[3] &&
        ...
        CardsUtils.fullHouse = function (card) {
            ...
            var firstCase = sortedRanks[0] == sortedRanks[1] &&
                ...
                sortedRanks[3] == sortedRanks[4];
            //xxxyy
            var secondCase = sortedRanks[0] == sortedRanks[1] &&
                sortedRanks[1] == sortedRanks[2] &&
                sortedRanks[3] == sortedRanks[4];
            return firstCase || secondCase;
        };
        ...
        CardsUtils.threeOfAKind = function (card) {
            ...
            var sortedRanks = ranks.sort();
            //xxx**
            var firstCase = sortedRanks[0] == sortedRanks[1] && sortedRanks[1] == sortedRanks[2];
            //*xxx*
            var secondCase = sortedRanks[1] == sortedRanks[2] && sortedRanks[2] == sortedRanks[3];
            //**xxx
            var thirdCase = sortedRanks[2] == sortedRanks[3] && sortedRanks[3] == sortedRanks[4];
        ...
        CardsUtils.twoPair = function (card) {
            ...
            var sortedRanks = ranks.sort();
            //xxyy*
            var firstCase = sortedRanks[0] == sortedRanks[1] && sortedRanks[2] == sortedRanks[3];
            //xx*yy
            var secondCase = sortedRanks[0] == sortedRanks[1] && sortedRanks[3] == sortedRanks[4];
            //*xxyy
            var thirdCase = sortedRanks[1] == sortedRanks[2] && sortedRanks[3] == sortedRanks[4];
            return firstCase || secondCase || thirdCase;
        };
        CardsUtils.onePairOfJacksOrBetter = function (card) {
            ...
            var sortedRanks = ranks.sort();
            //xx***
            var firstCase = sortedRanks[0] == sortedRanks[1] && (sortedRanks[0] == 0 || sortedRanks[0] > 10);
            //*xx**
            var secondCase = sortedRanks[1] == sortedRanks[2] && (sortedRanks[1] == 0 || sortedRanks[1] > 10);
            //**xx*
            var thirdCase = sortedRanks[2] == sortedRanks[3] && (sortedRanks[2] == 0 || sortedRanks[2] > 10);
            //***xx
            var forthCase = sortedRanks[3] == sortedRanks[4] && (sortedRanks[3] == 0 || sortedRanks[3] > 10);
        ...
        CardsUtils.getRanks = function (card) {
            var ranks = [];
            for (var _i = 0, card_2 = card; _i < card_2.length; _i++) {
                var currentCard = card_2[_i];
    ...
    var Server = /** @class */ (function () {
        ...
        Server.prototype.requestCollect = function () {
            if (this._state == "Collect") {
                var winAmount = this.getWinAmount();
        ...
        Server.prototype.getWinAmount = function () {
